...
class TrmnlDeviceModelsApiTest : BaseApiTest() {
    ...
    @Test
    fun `getDeviceModels returns 401 unauthorized for invalid token`() =
        runTest {
    ...
    @Test
    fun `getDeviceModels returns empty list when no models available`() =
        runTest {
    ...
    @Test
    fun `getDeviceModels handles server error`() =
        runTest {
    ...
    @Test
    fun `getDeviceModels returns 404 not found for invalid endpoint`() =
        runTest {
    ...
    @Test
    fun `getDeviceModels handles malformed JSON response`() =
        runTest {
    ...
    @Test
    fun `getDeviceModels handles network timeout`() =
        runTest {
