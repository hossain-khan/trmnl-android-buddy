...
class TrmnlDisplayApiTest : BaseApiTest() {
    ...
    @Test
    fun `getDisplayCurrent returns success with optional fields null`() =
        runTest {
            // Given
            val deviceApiKey = "abc-123"
            val mockResponse =
    ...
    @Test
    fun `getDisplayCurrent returns 401 Unauthorized`() =
        runTest {
            // Given
    ...
    @Test
    fun `getDisplayCurrent returns 500 Internal Server Error`() =
        runTest {
            // Given
            val deviceApiKey = "abc-123"
            val mockResponse =
    ...
    @Test
    fun `getDisplayCurrent handles network failure`() =
        runTest {
            // Given
    ...
    @Test
    fun `getDisplayCurrent parses all JSON fields correctly`() =
        runTest {
            // Given
