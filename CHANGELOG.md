...
- **Optimized unit test setup code** - Extracted duplicate Retrofit/OkHttp setup into reusable helper methods across API test files (TrmnlDeviceApiTest, TrmnlRecipesApiTest, TrmnlDeviceModelsApiTest), eliminating ~70 lines of duplicate code
